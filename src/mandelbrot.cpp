...
Panel::Panel(wxWindow* parent) : wxPanel(parent)
{
	...
	zoomFactorBox = new wxTextCtrl(this, wxID_ANY, "4", wxPoint(800, 360));
	zoomText = new wxStaticText(this, wxID_ANY, "Zoom factor: ", wxPoint(800, 340));

	keybindText = new wxStaticText(this, wxID_ANY, "press enter to zoom in\nand esc to zoom out", wxPoint(800, 400));
